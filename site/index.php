...
<head>
    <meta charset="UTF-8">
    <title>Développement Web - E1 P2025 - Bruno Simon</title>
...
<body>
    ...
    <nav class="navbar navbar-dark bg-dark">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">E1 P2025 - Dév<span class="hidden-xs">eloppement</span> Web</a>
            <ul class="nav navbar-nav navbar-right">
                <li><a class="btn btn-light" href="https://github.com/brunosimon/esin-e1-p2025" target="_blank">GitHub</a></li>
            </ul>
        </div>
    </nav>
